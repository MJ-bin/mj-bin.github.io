...
![alt text](/assets/img/posts/2026-05-05-new-post/image-7.png)

    훅 체인은 훅 종류별로 존재하며, 각각 종류별 조건(예를들어 WH_KEYBOARD 는 스레드가 GUI 메세지 큐를 사용하는 스레드만 적용)에 만족하는 스레드만 타겟으로 기능한다.

1. HookMain.exe 실행
![alt text](/assets/img/posts/2026-05-05-new-post/image.png)
![alt text](/assets/img/posts/2026-05-05-new-post/image-1.png)

2. notepad.exe 실행후 KeyHook.dll 인젝션 확인
![alt text](/assets/img/posts/2026-05-05-new-post/image-2.png)
> 인젝션이 되지 않음: 아직 notepad.exe 에 입력 이벤트가 발생하지 않아서 dll이 로드되지 않았다.
![alt text](/assets/img/posts/2026-05-05-new-post/image-3.png)

3. notepad.exe 에 키보드 입력
![alt text](/assets/img/posts/2026-05-05-new-post/image-4.png)
키보드 입력 이벤트가 발생하자, KeyHook.dll 이 로드된것을 확인할수 있다.

4. HookMain.exe 를 종료(키보드 훅 제거)
![alt text](/assets/img/posts/2026-05-05-new-post/image-5.png)
![alt text](/assets/img/posts/2026-05-05-new-post/image-6.png)
...
1. HookMain.exe main() 분석
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-8.png)
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-9.png)
...
2. HookStart() 안으로 추적, 분석
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-10.png)
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-11.png)
...
3. notepad.exe 분석
    ...
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-12.png)
    충분히 notepad.exe를 실행한다.

    그후 사용자 DLL 로드에 체크하고, HookMain.exe를 실행한다.
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-13.png)
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-14.png)

    notepad.exe에 키보드 입력을 시도하면 x32dbg가 로드된 KeyHook.dll에서 멈춰야하는데 왜 안멈추지?
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-15.png)
    ...
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-16.png)
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-17.png)

    DLL 로드직후 멈춘 디버거에서 메모리맵을 확인하면 KeyHook.dll 이 로드된것을 확인할수 있다.
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-19.png)
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-18.png)


4. KeyHook.dll 분석
    이전 `1. HookMain.exe main() 분석` 에서 찾은 KeyboardProc 프로시저 시작주소(10001020)에 bp를 건다.
    ![alt text](/assets/img/posts/2026-05-05-new-post/image-20.png)
